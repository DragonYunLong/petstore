...
import com.yunlong.api.model.ItemExample.Criteria;
import com.yunlong.api.model.ItemExample.Criterion;
...
public class ItemSqlProvider {
    ...
    public String insertSelective(Item record) {
        ...
        if (record.getListprice() != null) {
            VALUES("listprice", "#{listprice,jdbcType=DOUBLE}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getListprice() != null) {
            SET("listprice = #{record.listprice,jdbcType=DOUBLE}");
        }
    ...
    public String updateByPrimaryKeySelective(Item record) {
        ...
        if (record.getListprice() != null) {
            SET("listprice = #{listprice,jdbcType=DOUBLE}");
        }
