...
import com.yunlong.api.model.ItemExample;
...
public interface ItemMapper {
    ...
    @Insert({
        ...
        "#{productid,jdbcType=INTEGER}, #{listprice,jdbcType=DOUBLE}, ",
    ...
    @Results({
        ...
        @Result(column="listprice", property="listprice", jdbcType=JdbcType.DOUBLE),
        @Result(column="attr1", property="attr1", jdbcType=JdbcType.VARCHAR),
            @Result(column="productid",property="product",one = @One(select = "com.yunlong.provider.mapper.ProductMapper.selectByPrimaryKey"))
    })
